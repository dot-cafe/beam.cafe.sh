...
3. You have access to the dns-configuration of a domain.
...
We're using [cerbot](https://certbot.eff.org/) together with [letsencrypt](https://letsencrypt.org/) to get a free ssl certificate.
